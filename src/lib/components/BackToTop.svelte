...
{#if showButton}
    <button
        ...
        class="fixed bottom-8 right-8 z-50 group flex items-center justify-center w-14 h-14 bg-white/90 backdrop-blur-sm border-2 border-pink-100 rounded-full shadow-lg shadow-pink-100/50 hover:shadow-pink-200 hover:-translate-y-1 hover:scale-105 active:scale-95 transition-all duration-300"
